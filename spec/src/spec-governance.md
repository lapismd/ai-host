...
| AH-GOV-005 | The configured spec-first gate MUST map package and source changes to Architecture, Protocol, or Executor. It MUST map validation, workspace, and agent-guidance changes to Specification Governance.                               |
